...
public class ProgressBarController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // El salón del alumno ya se cargó una sola vez al iniciar sesión (MenuInicio) y
        // queda cacheado aquí, así que no hace falta otra consulta a Firestore por cada botón de juego.
        salonActual = gameManager.GetSalonActual();
        if (salonActual == null)
        {
            Debug.LogWarning("No hay un salón cargado para el usuario actual; no se puede mostrar el progreso.");
            return;
        }
