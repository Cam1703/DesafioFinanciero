...
public class DecisionesBancariasScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // La configuración puede pedir más preguntas de las que existen; sin este
        // límite el juego lanza IndexOutOfRangeException al pasar del último nivel.
    ...
    void ActualizarNivel()
    {
        ...
        else if (!habilitarPrimeraEtapa)
        {
            ...
            // Con la primera etapa deshabilitada nunca se pasa por la transición que
            // asigna estos textos, así que los botones mostraban las opciones del nivel anterior.
    ...
    void SeleccionarOpcionOfertantesODemandantes(int opcionSeleccionada) // 0 para ofertantes, 1 para demandantes
    {
        ...
        else
        {
            ...
            // La configuración guarda los puntos en contra como valor positivo,
            // por eso se resta su valor absoluto (sumarla directamente premiaba el error).
        ...
        if (habilitarPrimeraEtapa && !habilitarSegundaEtapa)
        {
            ...
            {
                // Antes este camino solo mostraba el panel sin guardar el puntaje,
                // así que jugar con la segunda etapa deshabilitada no registraba progreso.
                FinalizarJuego();
            }
        }
        else
    ...
    // Muestra el panel de fin de juego y guarda el progreso del alumno.
    // Centralizado aquí porque el juego puede terminar tanto en la etapa de
    // decisiones (TomarDecision) como en la de ofertantes/demandantes cuando
    // la segunda etapa está deshabilitada.
